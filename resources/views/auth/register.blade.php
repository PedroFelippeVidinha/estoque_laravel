        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route($registerUrl ?? 'register') }}">
                            @csrf
                            ...
                            @auth
                                {{-- Simples verificação se o usuario é super --}}
                                @if (auth()->user()->role === 'super-admin')
                                    <div class="row mb-3">
                                        <label for="email"
                                            class="col-md-4 col-form-label text-md-end">{{ __('Espaço') }}</label>

                                        <div class="col-md-6">
                                            <input id="space" type="text"
                                                class="form-control @error('space') is-invalid @enderror" name="space"
                                                value="{{ old('space') }}" required autocomplete="space">
